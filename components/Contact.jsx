    ...
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-24 w-full'>
        <p className='text-5xl tracking-widest uppercase text-center'>
          <span className='text-red-600'>Con</span><span className='text-zinc-900'>tac</span><span className='text-red-600'>t</span>
        </p>
        ...
        <div className='grid lg:grid-cols-5 gap-8'>
            ...
            <div className='lg:p-4 h-full '>
              ...
              <div>
                ...
                <div className='flex items-center justify-between py-4'>
                  ...
                  <a 
                  href='mailto:muhammadibnsalim@gmail.com' 
                  target='_blank' 
                  rel='noreferrer'
                  >
                  <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300'>
          ...
          <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
            <div className='p-4'>
              <form
                action='https://getform.io/f/7c2af00a-dc1a-41d9-b083-7d8b616a0704'
                method='POST'
